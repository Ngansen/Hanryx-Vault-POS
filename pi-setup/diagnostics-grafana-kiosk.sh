...
URL="https://hanryxvault.tailcfc0a3.ts.net/grafana/d/hanryx-pi-ops/hanryxvault-pi-operator?orgId=1&refresh=10s&kiosk&theme=dark"
USER_DATA_DIR=/tmp/chromium-grafana
HEALTH_URL="http://localhost/grafana/api/health"
